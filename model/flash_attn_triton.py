"""
Copied from https://huggingface.co/mosaicml/mpt-7b/blob/main/flash_attn_triton.py

Mosaic ML copy of flash attention for triton that is modified to use triton_pre_mlir version

Below the following line is a direct copy of the script.
